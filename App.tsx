    ...
    <div className="min-h-screen text-white selection:bg-neon-blue selection:text-black flex flex-col">
      ...
      <header className="absolute top-0 left-0 right-0 z-50 px-6 py-6 flex justify-between items-center pointer-events-none">
         ...
         <div className="flex items-center gap-3 pointer-events-auto">
             <div className="w-1.5 h-8 bg-gradient-to-b from-neon-blue to-blue-600 rounded-full shadow-[0_0_15px_#00f3ff]"></div>
             <div>
                <h1 className="text-2xl font-bold tracking-tight leading-none text-white">QR MAGIC</h1>
                <p className="text-[10px] text-gray-400 font-mono tracking-[0.2em] uppercase opacity-70">Particle System v2.2</p>
             </div>
         </div>

         {/* Social / Branding Deck */}
         <div className="pointer-events-auto flex items-center gap-3">
             {/* X (Twitter) Button */}
             <a 
                href="https://x.com/xwen_h" 
                target="_blank" 
                rel="noreferrer" 
                className="group flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/40 backdrop-blur-md border border-white/10 transition-all hover:bg-white/10 hover:border-white/20 hover:shadow-[0_0_15px_rgba(255,255,255,0.05)]"
             >
                <svg className="w-3.5 h-3.5 fill-gray-400 group-hover:fill-white transition-colors" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
                <span className="text-[10px] font-mono font-bold text-gray-400 group-hover:text-white uppercase tracking-wider hidden sm:inline">@xwen_h</span>
             </a>

             {/* GitHub Button */}
             <a 
                href="https://github.com/nanaco666/QR-Magic" 
                target="_blank" 
                rel="noreferrer" 
                className="group flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/40 backdrop-blur-md border border-white/10 transition-all hover:bg-white/10 hover:border-white/20 hover:shadow-[0_0_15px_rgba(255,255,255,0.05)]"
             >
                ...
                <span className="text-[10px] font-mono font-bold text-gray-400 group-hover:text-white uppercase tracking-wider hidden sm:inline">Star Project</span>
             </a>
         </div>
      </header>
